...
public class BinarizationUtil {
	...
	private static void processByAvg(BufferedImage bi , String destFile) throws ImageFormatException, IOException{
	 ...
	 * @throws IOException
	 */
	public static BufferedImage processByMaxOffset(BufferedImage bi , float percent) throws IOException{
		int h=bi.getHeight();//获取图像的高  
        int w=bi.getWidth();//获取图像的宽  
        int max = 0;
        for (int x = 0; x < w; x++) {  
