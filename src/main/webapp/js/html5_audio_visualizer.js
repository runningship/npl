...
Visualizer.prototype = {
    ...
    _drawSpectrum: function(analyser) {
        var that = this,
            ...
            capHeight = 2,
            capStyle = '#fff',
            meterNum = 1024 / (meterWidth + gap), //count of the meters
            capYPositionArray = []; ////store the vertical position of hte caps for the preivous frame
        var capWidth = meterWidth + gap;
        ...
        var drawMeter = function() {
            ...
            for (var i = 0; i < meterNum; i++) {
                ...
                if (value < capYPositionArray[i]) {
                    ctx.fillRect(i * capWidth, cheight - (--capYPositionArray[i]), meterWidth, capHeight);
                } else {
                    ctx.fillRect(i * capWidth, cheight - value, meterWidth, capHeight);
                    capYPositionArray[i] = value;
                };
                ctx.fillStyle = gradient; //set the filllStyle to gradient for a better look
                ctx.fillRect(i * capWidth /*meterWidth+gap*/ , cheight - value + capHeight, meterWidth, cheight); //the meter
            }
